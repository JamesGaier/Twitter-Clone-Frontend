...
const Signup = (props: Props): ReactElement => {
    ...
    return (
        <div className="signup container flex justify-content-center">
            <div className="signup-info">
                ...
                <h3 className="action-text">See what's happening in<br/> the world right now</h3>
                <h4 className="join">Join Twitter today</h4>
                <div className="btn m-btn" onClick={e => handleClick()}>Sign up</div>
                <div className="btn btn-op">Log in</div>
            </div>
        </div>
    )
};
